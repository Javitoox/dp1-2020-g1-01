...
public interface AlumnoRepository extends CrudRepository<Alumno, String> {
	...
	@Query(value="SELECT * FROM ALUMNOS WHERE FECHA_MATRICULACION IS NOT NULL",nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM ALUMNOS where(tutores_nick_usuario_tutor=:nickTutor and FECHA_MATRICULACION IS NOT NULL)",nativeQuery = true)
